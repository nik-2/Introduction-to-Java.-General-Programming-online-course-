    ...
    public static void main(String[] args) {
            ...
            if(n == 3)
            {
                ...
                switch (kod)
                {
                    ...
                    case 2:
                        ...
                        for (int i = 0; i < array_magic.length; i++) {
                            for (int j = 0; j < array_magic[i].length; j++) {
                                System.out.print("\t" + array_magic[i][j]);
                            }
                            System.out.println("\n");
                        }
                        break;
        ...
        if (n % 2 == 0)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < array_dop.length; i++) {
                    for (int j = 0; j < array_dop.length; j++) {
                        array_dop[i][j] = kol_dop;
                        kol_dop++;
                    }
                }
                int[][] array_magic = new int[number][number];
                int n_start = (number / 2) + 2;
                int sum;
                for (int i = 0; i < array_magic.length; i++) {
                    if (i % 2 == 0) {
                        n_start--;
                ...
                do {
                    int kol_col = 0;
                    for (int i = number / 2 + kol; i >= 1 + kol * 2; i--) {
                        int j = number - number / 2 + kol_col + kol;
                        array_magic[i][j] = array_temp.get(temp);
                        kol_col++;
                        temp++;
                    }
                ...
                temp = 0;
                for (int i = 0; i < number / 2; i++) {
                    for (int j = number / 2 + 1 + i; j < number; j++) {
                        array_temp.set(temp, array_dop[i][j]);
                        temp++;
                    }
                }
                temp = 0;
                ...
                do {
                    int kol_col = 0;
                    for (int i = number - 1; i > number / 2 + need; i--) {
                        int j = 1 + kol_col + kol;
                        array_magic[i][j] = array_temp.get(temp);
                        kol_col++;
                        temp++;
                ...
                for (int j = number - 1; j > number / 2; j--) {
                    for (int i = number / 2 + 1 + need; i < number; i++) {
                        array_temp.set(temp, array_dop[i][j]);
                        temp++;
                    }
                    need++;
